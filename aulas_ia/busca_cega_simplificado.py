class Matriz:
    ...
    def concluido(self):
        return self.matriz == [[0,1,2],[3,4,5]]
...
class Borda:
    ...
    def solucionar(self):
        try:
            ...
            print("Acabou sem solução!")
            print(No(Matriz(*[0,1,2,3,4,5]), None, 1) in self.visitados)
            print(No(Matriz(*[0,1,2,3,4,5]), None, 1) in self.nao_visitados)
...
#b = Borda([3,1,2,4,5,0])
b.solucionar()
"""m = Matriz(0,1,2,3,4,5)
m.imprimir_todos()
m.imprimir_adjacentes(m.localizar_zero())
for a in m.get_sucessores():
    a.imprimir_todos()"""